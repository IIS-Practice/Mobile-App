      ...
      <SafeAreaView>
        <View style={styles.content}>
          <Text style={styles.headerText}>
            <Text style={styles.designWord}>Дизайн </Text>интерфейсов любой
            сложности
          </Text>
...
приведёт к увеличению\nконверсии, продвижению товаров\nи улучшением обслуживания\nклиентов.`}
          ...
          <View style={styles.exampleContainers}>
            <View style={styles.example}>
              <Text style={styles.exampleText}>Сайты</Text>
            </View>
            <View style={styles.example}>
              <Text style={styles.exampleText}>Веб-приложения</Text>
            </View>
            <View style={styles.example}>
              <Text style={styles.exampleText}>Мобильные приложения</Text>
            </View>
          </View>
...
иллюстраторами.`}
          ...
          <View style={styles.anotherContainer}>
            <Text
              style={
                styles.anotherContainerHeading
              }>{`Прозрачность процесса и синхронизация\nс бизнесом`}</Text>
            <Text
              style={
                styles.anotherContainerText
              }>{`Сверяемся с клиентом на каждом\nэтапе, а не молчим несколько\nмесяцев, пока не сделаем
...
превращается в финальный\nдизайн.`}</Text>
            <View style={styles.anotherContainerPoints}>
              <View style={styles.pointWrapper}>
                ...
                <Text style={styles.anotherContainerPointsText}>
                  Все видно в Фигме
                </Text>
              </View>
              <View style={styles.pointWrapper}>
